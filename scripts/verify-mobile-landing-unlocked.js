...
(async () => {
  ...
  await page.evaluate(() => {
    localStorage.setItem('harkat_ig_followed', 'true');
    location.reload();
  });
  await page.waitForNavigation({ waitUntil: 'networkidle0' });
  await page.screenshot({ path: '/root/harkat-photobooth/test-output/mobile_landing_unlocked.png' });

  await browser.close();
  console.log('Unlocked landing page screenshot saved');
